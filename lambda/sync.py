...
class DataSync:
    def __init__(self, output_dir: str = DATA_DIR):
        ...
        self.specs = [
            ...
            DatasetSpec("rushing_next_gen_stats",          fr.get_ngs_rushing,    None, gzipped=True),
            DatasetSpec("passing_next_gen_stats",          fr.get_ngs_passing,    None, gzipped=True),
            DatasetSpec("receiving_next_gen_stats",        fr.get_ngs_receiving,  None, gzipped=True),
