...
BEGIN
  ...
  -- snaps data
  FOR season IN 2012..2024 LOOP
    PERFORM import_snaps_data(season);
  END LOOP;
  

  -- rosters
  FOR season IN 2002..2024 LOOP
    PERFORM import_rosters_data(season);
  END LOOP;
  
  -- ftn data
  PERFORM import_ftn_data(2024);
